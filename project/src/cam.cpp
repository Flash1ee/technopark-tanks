...
void Cam::changeViewCoords(float x, float y) { //функция для считывания координат игрока
	...
	if (x < 190) tempX = 190;//убираем из вида левую сторону
	if (x > 192) tempX = 192;//убираем из вида правую сторону
	if (y < 92) tempY = 92;//верхнюю сторону
	if (y > 292) tempY = 292;//нижнюю сторону	
